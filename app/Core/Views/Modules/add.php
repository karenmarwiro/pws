                        ...
                        <div id="moduleDetails" class="d-none">
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="module_name" class="form-control" id="moduleName" required>
                                    <div class="invalid-feedback">Please provide a module name.</div>
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Version</label>
                                    <input type="text" name="module_version" class="form-control" id="moduleVersion" value="1.0.0" required>
                                    <div class="invalid-feedback">Please provide a version number.</div>
                                </div>
                                <div class="col-12">
                                    <label class="form-label">Description</label>
                                    <textarea class="form-control" name="module_description" id="moduleDescription" rows="2" required></textarea>
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        return new Promise((resolve) => {
            setTimeout(() => {
                ...
                const moduleInfo = {
                    name: friendlyName,
                    version: '1.0.0',
                    description: 'A new module for your application.'
                };
                
                // Update the UI with module info
                const nameInput = document.getElementById('moduleName');
                if (!nameInput.value) {
                    nameInput.value = moduleInfo.name;
                }
                
                const versionInput = document.getElementById('moduleVersion');
                if (!versionInput.value) {
                    versionInput.value = moduleInfo.version;
                }
                ...
                document.getElementById('moduleDetails').classList.remove('d-none');
    ...
    async function handleFormSubmit(e) {
        ...
        // Manually create FormData and append all form fields
        ...
        formData.append('module_version', document.getElementById('moduleVersion').value);
        ...
        try {
                ...
                if (xhr.readyState === 4) {
                    ...
                    try {
                        ...
                        if (xhr.status === 200) {
                            ...
                            const errorMsg = response.message || 'An error occurred while installing the module.';
                            showError('Installation Failed', errorMsg);
                            uploadProgressContainer.classList.add('d-none');
                        }
                    } catch (e) {
                        console.error('Error processing response:', e);
                        showError('Error', 'An unexpected error occurred. Please check the console for details.');
                        uploadProgressContainer.classList.add('d-none');
                    }
                }
            };
            ...
            showError('Installation Failed', error.message || 'An error occurred while installing the module.');
            uploadBtn.disabled = false;
            uploadBtn.innerHTML = '<i class="bx bx-upload me-2"></i>Install Module';
            uploadProgressContainer.classList.add('d-none');
        }
