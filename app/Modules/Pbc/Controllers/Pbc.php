...
public function edit($id = null)
{
    ...
    return view('App\Modules\Pbc\Views\edit_application', [
...
{
    if (!$id) {
        return redirect()->to(site_url('pbc'))->with('error', 'Application ID not provided.');
    }

    $application = $this->applicationsModel->find($id);
    if (!$application) {
        return redirect()->to(site_url('pbc'))->with('error', 'Application not found.');
    }
    ...
    if ($this->applicationsModel->update($id, $application)) {
        return redirect()->to(site_url('pbc/view/' . $id))
...
public function shareholder($id = null)
{
    ...
    return view('App\Modules\Pbc\Views\view_shareholder', [
