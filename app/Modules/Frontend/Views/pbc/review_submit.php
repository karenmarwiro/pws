...
<head>
    ...
    <title>Review Application - PBC Registration</title>
    <!-- Bootstrap 5 CSS -->
...
<h5 class="section-title d-flex justify-content-between align-items-center">
    ...
    <a href="<?= site_url('frontend/pbc/personal-details?edit=1') ?>" class="btn btn-sm btn-outline-primary">
...
<h5 class="section-title d-flex justify-content-between align-items-center">
    ...
    <a href="<?= site_url('frontend/pbc/company-details?edit=1') ?>" class="btn btn-sm btn-outline-primary">
        <i class="fas fa-edit"></i> Edit
    </a>
</h5>
<div class="detail-card">
...
<h5 class="section-title d-flex justify-content-between align-items-center">
    ...
    <a href="<?= site_url('frontend/pbc/directors-shareholders?edit=1') ?>" class="btn btn-sm btn-outline-primary">
        <i class="fas fa-edit"></i> Edit
    </a>
</h5>
