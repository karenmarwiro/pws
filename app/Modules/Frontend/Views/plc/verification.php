...
<head>
    ...
    <title>Verification - PLC Registration</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="verification-container">
                    ...
                    <form id="verificationForm" action="<?= site_url('plc/process-verification') ?>" method="post">
                        <?= csrf_field() ?>
                        ...
                        <div class="d-flex justify-content-between">
                            <a href="<?= site_url('plc/directors-shareholders') ?>" class="btn btn-outline-secondary">
